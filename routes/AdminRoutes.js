...
router.post('/create-user', multer().any(), auth, checkPermission('create-user'), user_validation.register, adminController.createUser);
...
router.get('/user-list', multer().any(), auth, checkPermission('view-user'), adminController.userList);
